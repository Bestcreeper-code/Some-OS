...
#define MODE13H_COLOR_PALETTE_SIZE                       (kernel_data.mode13h_color_palette_size)    // 
#define MODE13H_COLOR_PALETTE                            (kernel_data.mode13h_color_palette)    // the color palette of mode 13h(256 entries of 3 bytes each)
