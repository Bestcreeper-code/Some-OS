...
#define USB_STICKS_DATA_ARRAY_ADDRESS   (usb_stick_t*)0x1E6D // array of 4 usb_stick_t
#define MODE13H_COLOR_PALETTE_SIZE            (char*)0x1E99 // 
#define MODE13H_COLOR_PALETTE             (RGBColor*)0x1E9A // the color palette of mode 13h(256 entries of 3 bytes each)
#define MOUSE_PREV_BG                      (uint8_t*)0x219A // 4x6=24 bytes (uint8_t[24])
#define MOUSE_X_POS_PREV                     (short*)0x21B2 // int16_t
#define MOUSE_Y_POS_PREV                     (short*)0x21B4 // int16_t
#define MOUSE_FLAGS_ADDR                   (uint8_t*)0x21B6 // uint8_t
#define MOUSE_Y_POS_ADDR                     (short*)0x21B7 // int16_t
#define MOUSE_X_POS_ADDR                     (short*)0x21B9 // int16_t
#define CONSOLE_REQUEST_QUEUE                (char**)0x21BB // 32 char*(commands) that apps can request to the console on exit
