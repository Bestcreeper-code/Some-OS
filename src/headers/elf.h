...
#define DEFAULT_USTACK_TOP_VADDR        (0xE0000000 )
#define DEFAULT_USTACK_BOTTOM_VADDR     (DEFAULT_USTACK_TOP_VADDR - (DEFAULT_STACK_PAGE_AMOUNT * _PAGE_SIZE) )

#define DEFAULT_KSTACK_TOP_VADDR       (DEFAULT_USTACK_BOTTOM_VADDR)
#define DEFAULT_KSTACK_BOTTOM_VADDR    (DEFAULT_KSTACK_TOP_VADDR - (DEFAULT_STACK_PAGE_AMOUNT * _PAGE_SIZE) )
