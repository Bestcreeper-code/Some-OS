...
#define DEFAULT_USTACK_BOTTOM_VADDR     (DEFAULT_USTACK_TOP_VADDR - (DEFAULT_STACK_PAGE_AMOUNT * PAGE_SIZE) )

#define DEFAULT_KSTACK_TOP_VADDR       (DEFAULT_USTACK_BOTTOM_VADDR)
#define DEFAULT_KSTACK_BOTTOM_VADDR    (DEFAULT_KSTACK_TOP_VADDR - (DEFAULT_STACK_PAGE_AMOUNT * PAGE_SIZE) )
