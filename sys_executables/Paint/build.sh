...
gcc -m32 -ffreestanding -fno-pic -fno-plt -fno-pie -c sys_executables/Paint/Paint.c -o build_execs/Paint.o
gcc -m32 -ffreestanding -fno-pic -fno-plt -fno-pie -c sys_executables/Paint/Graphics/graphics.c -o build_execs/graphics.o
gcc -m32 -ffreestanding -fno-pic -fno-plt -fno-pie -c sys_executables/Paint/res.c -o build_execs/res.o


# Create relocatable ELF with relocation info preserved
ld -m elf_i386 -r -o build_execs/Paint.rel build_execs/Paint.o build_execs/graphics.o build_execs/res.o build_lib/libsys.a
